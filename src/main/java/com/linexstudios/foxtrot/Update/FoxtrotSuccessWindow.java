    ...
    public FoxtrotSuccessWindow(String targetVersion, Runnable onConfirm) {
        ...
        try {
            ...
            if (regularStream != null && thinStream != null) {
                ...
                textFontSmall = regularFont.deriveFont(Font.PLAIN, 15f);
                textFontLarge = thinFont.deriveFont(Font.PLAIN, 24f); 
                
                GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
                ge.registerFont(regularFont);
                ge.registerFont(thinFont);
            } else {
                textFontLarge = new Font(Font.SANS_SERIF, Font.PLAIN, 24);
                textFontSmall = new Font(Font.SANS_SERIF, Font.PLAIN, 15);
            }
        } catch (Exception e) {
            textFontLarge = new Font(Font.SANS_SERIF, Font.PLAIN, 24);
            textFontSmall = new Font(Font.SANS_SERIF, Font.PLAIN, 15);
        ...
        int btnWidth = 140;
        int btnHeight = 35;
        okButtonBounds = new Rectangle((getWidth() - btnWidth) / 2, 220, btnWidth, btnHeight);
        ...
        setContentPane(new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (logoImage != null) {
                    ...
                    g2d.drawImage(logoImage, (getWidth() - logoW) / 2, 30, logoW, logoH, null);
                }

                g2d.setColor(new Color(230, 40, 40));
                g2d.setFont(textFontLarge);
                String title = "UPDATE COMPLETE";
                g2d.drawString(title, (getWidth() - g2d.getFontMetrics().stringWidth(title)) / 2, 120);

                g2d.setColor(Color.WHITE);
                g2d.setFont(textFontSmall);
                String l1 = "Foxtrot v" + targetVersion + " has been successfully downloaded.";
                String l2 = "Minecraft will now close to safely apply the update.";
                String l3 = "Please relaunch your game!";
                
                g2d.drawString(l1, (getWidth() - g2d.getFontMetrics().stringWidth(l1)) / 2, 155);
                g2d.drawString(l2, (getWidth() - g2d.getFontMetrics().stringWidth(l2)) / 2, 175);
                g2d.drawString(l3, (getWidth() - g2d.getFontMetrics().stringWidth(l3)) / 2, 195);

                g2d.setColor(isHoveringOK ? new Color(255, 60, 60) : new Color(230, 40, 40));
                g2d.fillRoundRect(okButtonBounds.x, okButtonBounds.y, okButtonBounds.width, okButtonBounds.height, 10, 10);
                
                g2d.setColor(Color.WHITE);
                g2d.setFont(textFontSmall.deriveFont(Font.BOLD, 14f));
                String btnText = "CLOSE GAME";
                g2d.drawString(btnText, okButtonBounds.x + (okButtonBounds.width - g2d.getFontMetrics().stringWidth(btnText)) / 2, okButtonBounds.y + 22);
        ...
        MouseAdapter mouseAdapter = new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                boolean wasHovering = isHoveringOK;
                isHoveringOK = okButtonBounds.contains(e.getPoint());
                if (wasHovering != isHoveringOK) {
                    repaint();
                }
            }
            ...
            public void mouseClicked(MouseEvent e) {
                if (okButtonBounds.contains(e.getPoint())) {
                    dispose();
                    if (onConfirm != null) onConfirm.run(); 
                    
                    try {
                        // Forcefully kill the process at the OS level to avoid Forge's shutdown thread hang
                    ...
                    // Fallback to halt if taskkill fails
